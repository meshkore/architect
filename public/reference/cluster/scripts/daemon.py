...
DAEMON_VERSION = "py-1.25.3"  # early bundle marker for the version-watcher 8 KB range-fetch; canonical def inlined below.
...
# ── inlined from daemon/protocols.py (DM3+ bundle) ─────────────────────────
