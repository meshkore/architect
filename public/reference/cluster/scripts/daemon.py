...
DAEMON_VERSION = "py-1.30.1"  # early bundle marker for the version-watcher 8 KB range-fetch; canonical def inlined below.
...
# ── inlined from daemon/teamext.py (DM3+ bundle) ─────────────────────────
...
# ── inlined from daemon/remotectl.py (DM3+ bundle) ─────────────────────────
