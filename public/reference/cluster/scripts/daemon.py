...
DAEMON_VERSION = "py-1.32.2"  # early bundle marker for the version-watcher 8 KB range-fetch; canonical def inlined below.
...
# ── inlined from daemon/providers.py (DM3+ bundle) ─────────────────────────
...
# ── inlined from daemon/providersvc.py (DM3+ bundle) ─────────────────────────
...
class ProvidersMixin:
    ...
    def resolve_provider(self, provider_id: Optional[str]) -> Dict[str, Any]:
        ...
        base_url = str(pcfg.get("base_url") or meta.get("default_base_url") or "").strip()
        small = str(
    ...
    def _auth_slot_config_entry(self, slot_id: str, providers_cfg: Dict[str, Any]) -> Dict[str, Any]:
