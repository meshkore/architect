/**
 * onboarding-brief.ts — the V46 "bootstrap brief" attached as a
 * context_doc on the first message of the synthetic Coordinator
 * conversation when the cluster is still empty. Byte-identical to
